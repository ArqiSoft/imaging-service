...
{
    public class MsPowerPointPptFileTestFixture
    {
    ...
    public class MsPowerPointPptFileTest : ImagingTest, IClassFixture<MsPowerPointPptFileTestFixture>
    {
        ...
        public MsPowerPointPptFileTest(ImagingTestHarness harness, ITestOutputHelper output, MsPowerPointPptFileTestFixture initFixture) : base(harness, output)
        {
            Id = initFixture.Id;
        ...
        [Fact]
        public void MsExcelXlsImageGenetating_ValidMolFile_ReceivedEventShouldContainValidData()
        {
            var evn = Harness.GetImageGeneratedEvent(Id);
