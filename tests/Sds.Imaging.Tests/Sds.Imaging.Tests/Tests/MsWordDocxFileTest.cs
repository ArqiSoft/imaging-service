...
{
    public class MsWordDocxFileTestFixture
    {
    ...
    public class MsWordDocxFileTest : ImagingTest, IClassFixture<MsWordDocxFileTestFixture>
    {
        ...
        public MsWordDocxFileTest(ImagingTestHarness harness, ITestOutputHelper output, MsWordDocxFileTestFixture initFixture) : base(harness, output)
        {
            Id = initFixture.Id;
        ...
        [Fact]
        public async Task MsWordDocxImageGenetating_ValidFile_ShouldGenerateOneImage()
        {
        ...
        [Fact]
        public void MsWordDocxImageGenetating_ValidMolFile_ReceivedEventShouldContainValidData()
        {
            var evn = Harness.GetImageGeneratedEvent(Id);
