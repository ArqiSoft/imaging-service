...
{
    public class MsExcelXlsxFileTestFixture
    {
    ...
    public class MsExcelXlsxFileTest : ImagingTest, IClassFixture<MsExcelXlsxFileTestFixture>
    {
        ...
        [Fact]
        public async Task MsExcelXlsxImageGenetating_ValidFile_ShouldGenerateOneImage()
        {
